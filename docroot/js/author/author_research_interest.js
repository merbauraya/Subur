AUI.add(
	'research-interest-tags-selector',
	function(A) {
		var Lang = A.Lang;
		console.log('x');
		var AArray = A.Array;

		var NAME = 'researchInterestselector';

		var CSS_INPUT_NODE = 'lfr-ri-selector-input';

		var CSS_NO_MATCHES = 'no-matches';

		var CSS_POPUP = 'lfr-ri-selector-popup';

		var CSS_TAGS_LIST = 'lfr-ri-selector-list';
		...
		var TPL_SEARCH_FORM = '<form id="sfm1" action="javascript:;" class="form-search lfr-tag-selector-search row-fluid">' +
		...
		var ResearchInterestTagsSelector = A.Component.create(
			{
				ATTRS: {
					allowAnyEntry: {
						value: true
				...
				prototype: {
					renderUI: function() {
						...
						ResearchInterestTagsSelector.superclass.renderUI.apply(instance, arguments);
					...
					bindUI: function() {
						...
						ResearchInterestTagsSelector.superclass.bindUI.apply(instance, arguments);
					...
					syncUI: function() {
						...
						ResearchInterestTagsSelector.superclass.syncUI.apply(instance, arguments);
					...
					_getEntries: function(callback) {
						...
						Liferay.Service(
							'/Subur-portlet.researchinterest/get-group-research-interests',
							{
					...
					_getTagsDataSource: function() {
						...
						var ResearchInterestTagSearch = Liferay.Service.bind('/Subur-portlet.researchinterest/search');

						ResearchInterestTagSearch._serviceQueryCache = {};

						var serviceQueryCache = ResearchInterestTagSearch._serviceQueryCache;
						...
						var dataSource = new Liferay.Service.DataSource(
							{
								...
								source: ResearchInterestTagSearch
							}
						).plug(
						...
						TPL_TAG.render(
							{
								...
								message: Liferay.Language.get('no-research-interest-found'),
								name: data.name,
								tags: data
							},
							popup.entriesNode
		...
		Liferay.ResearchInterestTagsSelector = ResearchInterestTagsSelector;
	},
	'',
	{
		requires: [
