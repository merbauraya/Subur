...
import com.idetronic.subur.service.HChartSeriesLocalService;
...
import com.idetronic.subur.service.persistence.HChartDataPersistence;
import com.idetronic.subur.service.persistence.HChartSeriesPersistence;
...
/**
 * Provides the base implementation for the h chart series local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.idetronic.subur.service.impl.HChartSeriesLocalServiceImpl}.
 * </p>
 *
 * @author Mazlan Mat
 * @see com.idetronic.subur.service.impl.HChartSeriesLocalServiceImpl
 * @see com.idetronic.subur.service.HChartSeriesLocalServiceUtil
 * @generated
 */
public abstract class HChartSeriesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements HChartSeriesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.idetronic.subur.service.HChartSeriesLocalServiceUtil} to access the h chart series local service.
	 */
	...
	@Override
	public HChartSeries addHChartSeries(HChartSeries hChartSeries)
		throws SystemException {
		hChartSeries.setNew(true);

		return hChartSeriesPersistence.update(hChartSeries);
	}
	 ...
	 */
	@Override
	public HChartSeries createHChartSeries(long hChartSeriesId) {
		return hChartSeriesPersistence.create(hChartSeriesId);
	}
	...
	@Override
	public HChartSeries deleteHChartSeries(long hChartSeriesId)
		throws PortalException, SystemException {
		return hChartSeriesPersistence.remove(hChartSeriesId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public HChartSeries deleteHChartSeries(HChartSeries hChartSeries)
		throws SystemException {
		return hChartSeriesPersistence.remove(hChartSeries);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(HChartSeries.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return hChartSeriesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return hChartSeriesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public HChartSeries fetchHChartSeries(long hChartSeriesId)
		throws SystemException {
		return hChartSeriesPersistence.fetchByPrimaryKey(hChartSeriesId);
	}
	 ...
	 */
	@Override
	public HChartSeries getHChartSeries(long hChartSeriesId)
		throws PortalException, SystemException {
		return hChartSeriesPersistence.findByPrimaryKey(hChartSeriesId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return hChartSeriesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<HChartSeries> getHChartSerieses(int start, int end)
		throws SystemException {
		return hChartSeriesPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getHChartSeriesesCount() throws SystemException {
		return hChartSeriesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public HChartSeries updateHChartSeries(HChartSeries hChartSeries)
		throws SystemException {
		return hChartSeriesPersistence.update(hChartSeries);
	}
	...
	/**
	 * Returns the h chart data local service.
	 *
	 * @return the h chart data local service
	 */
	public com.idetronic.subur.service.HChartDataLocalService getHChartDataLocalService() {
		return hChartDataLocalService;
	}

	/**
	 * Sets the h chart data local service.
	 *
	 * @param hChartDataLocalService the h chart data local service
	 */
	public void setHChartDataLocalService(
		com.idetronic.subur.service.HChartDataLocalService hChartDataLocalService) {
		this.hChartDataLocalService = hChartDataLocalService;
	}

	/**
	 * Returns the h chart data remote service.
	 *
	 * @return the h chart data remote service
	 */
	public com.idetronic.subur.service.HChartDataService getHChartDataService() {
		return hChartDataService;
	}

	/**
	 * Sets the h chart data remote service.
	 *
	 * @param hChartDataService the h chart data remote service
	 */
	public void setHChartDataService(
		com.idetronic.subur.service.HChartDataService hChartDataService) {
		this.hChartDataService = hChartDataService;
	}

	/**
	 * Returns the h chart data persistence.
	 *
	 * @return the h chart data persistence
	 */
	public HChartDataPersistence getHChartDataPersistence() {
		return hChartDataPersistence;
	}

	/**
	 * Sets the h chart data persistence.
	 *
	 * @param hChartDataPersistence the h chart data persistence
	 */
	public void setHChartDataPersistence(
		HChartDataPersistence hChartDataPersistence) {
		this.hChartDataPersistence = hChartDataPersistence;
	}

	/**
	 * Returns the h chart series local service.
	 *
	 * @return the h chart series local service
	 */
	public com.idetronic.subur.service.HChartSeriesLocalService getHChartSeriesLocalService() {
		return hChartSeriesLocalService;
	}

	/**
	 * Sets the h chart series local service.
	 *
	 * @param hChartSeriesLocalService the h chart series local service
	 */
	public void setHChartSeriesLocalService(
		com.idetronic.subur.service.HChartSeriesLocalService hChartSeriesLocalService) {
		this.hChartSeriesLocalService = hChartSeriesLocalService;
	}

	/**
	 * Returns the h chart series remote service.
	 *
	 * @return the h chart series remote service
	 */
	public com.idetronic.subur.service.HChartSeriesService getHChartSeriesService() {
		return hChartSeriesService;
	}

	/**
	 * Sets the h chart series remote service.
	 *
	 * @param hChartSeriesService the h chart series remote service
	 */
	public void setHChartSeriesService(
		com.idetronic.subur.service.HChartSeriesService hChartSeriesService) {
		this.hChartSeriesService = hChartSeriesService;
	}

	/**
	 * Returns the h chart series persistence.
	 *
	 * @return the h chart series persistence
	 */
	public HChartSeriesPersistence getHChartSeriesPersistence() {
		return hChartSeriesPersistence;
	}

	/**
	 * Sets the h chart series persistence.
	 *
	 * @param hChartSeriesPersistence the h chart series persistence
	 */
	public void setHChartSeriesPersistence(
		HChartSeriesPersistence hChartSeriesPersistence) {
		this.hChartSeriesPersistence = hChartSeriesPersistence;
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.idetronic.subur.model.HChartSeries",
			hChartSeriesLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = hChartSeriesPersistence.getDataSource();
	...
	@BeanReference(type = com.idetronic.subur.service.HChartDataLocalService.class)
	protected com.idetronic.subur.service.HChartDataLocalService hChartDataLocalService;
	@BeanReference(type = com.idetronic.subur.service.HChartDataService.class)
	protected com.idetronic.subur.service.HChartDataService hChartDataService;
	@BeanReference(type = HChartDataPersistence.class)
	protected HChartDataPersistence hChartDataPersistence;
	@BeanReference(type = com.idetronic.subur.service.HChartSeriesLocalService.class)
	protected com.idetronic.subur.service.HChartSeriesLocalService hChartSeriesLocalService;
	@BeanReference(type = com.idetronic.subur.service.HChartSeriesService.class)
	protected com.idetronic.subur.service.HChartSeriesService hChartSeriesService;
	@BeanReference(type = HChartSeriesPersistence.class)
	protected HChartSeriesPersistence hChartSeriesPersistence;
	...
	private HChartSeriesLocalServiceClpInvoker _clpInvoker = new HChartSeriesLocalServiceClpInvoker();
}