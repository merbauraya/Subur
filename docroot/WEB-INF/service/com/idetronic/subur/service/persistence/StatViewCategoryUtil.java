...
public class StatViewCategoryUtil {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.subur.model.StatViewCategory findByCategoryPeriod(
		long companyId, long groupId, long categoryId, int perYear, int perMonth)
		throws com.idetronic.subur.NoSuchStatViewCategoryException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .findByCategoryPeriod(companyId, groupId, categoryId,
			perYear, perMonth);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.subur.model.StatViewCategory fetchByCategoryPeriod(
		long companyId, long groupId, long categoryId, int perYear, int perMonth)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .fetchByCategoryPeriod(companyId, groupId, categoryId,
			perYear, perMonth);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.idetronic.subur.model.StatViewCategory removeByCategoryPeriod(
		long companyId, long groupId, long categoryId, int perYear, int perMonth)
		throws com.idetronic.subur.NoSuchStatViewCategoryException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .removeByCategoryPeriod(companyId, groupId, categoryId,
			perYear, perMonth);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int countByCategoryPeriod(long companyId, long groupId,
		long categoryId, int perYear, int perMonth)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .countByCategoryPeriod(companyId, groupId, categoryId,
			perYear, perMonth);
	}
