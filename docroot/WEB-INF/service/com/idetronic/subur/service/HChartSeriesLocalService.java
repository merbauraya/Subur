...
/**
 * Provides the local service interface for HChartSeries. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mazlan Mat
 * @see HChartSeriesLocalServiceUtil
...
public interface HChartSeriesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HChartSeriesLocalServiceUtil} to access the h chart series local service. Add custom service methods to {@link com.idetronic.subur.service.impl.HChartSeriesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
