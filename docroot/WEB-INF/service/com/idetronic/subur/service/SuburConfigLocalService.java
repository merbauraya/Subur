...
/**
 * Provides the local service interface for SuburConfig. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Mazlan Mat
 * @see SuburConfigLocalServiceUtil
...
public interface SuburConfigLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SuburConfigLocalServiceUtil} to access the subur config local service. Add custom service methods to {@link com.idetronic.subur.service.impl.SuburConfigLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
