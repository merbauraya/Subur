 ...
 * @generated
 */
public class SuburItemServiceClp implements SuburItemService {
	public SuburItemServiceClp(InvokableService invokableService) {
	...
	public com.idetronic.subur.model.SuburItem getSuburItem(long suburItemId)
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName3,
					_methodParameterTypes3, new Object[] { suburItemId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);

			if (t instanceof com.idetronic.subur.NoSuchItemException) {
				throw (com.idetronic.subur.NoSuchItemException)t;
			}
