...
%>	
	...
	<%@ include file="/html/subur/toolbar.jsp" %>
	</aui:form>
	...
	<liferay-util:include page="/html/subur/admin/view_publication.jsp" servletContext="<%= application %>" >
		<liferay-util:param name="status" value="<%= String.valueOf(status) %>" />
		<liferay-util:param name="tabs1" value="<%=viewTab %>" />
